...
class Vehicle implements Driveable {
  static push: any;
  static map(arg0: (vehicle: any) => { name: string; value: any; }): import("inquirer").AsyncDynamicQuestionProperty<readonly import("inquirer").DistinctChoice<any, import("inquirer").ListChoiceMap<any>>[], any> | undefined {
